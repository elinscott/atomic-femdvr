...
class PseudoAtomDFT:
    ...
    # .......................................................
    def _build_basis_tag(
        self,
        lmax: int,
        nmax: int,
        confinement: ConfinementInput | None = None,
        ...
        if self.upf is None:
            raise RuntimeError("read_upf() must be called before building a basis tag.")
        ...
        if (
            include_confinement
            and confinement is not None
            and confinement.type != ConfinementType.NONE
        ):
